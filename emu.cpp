...
int idaapi emu(void)
{
  ...
  {
    case CRIS_INSN_X_INVALID: len = fr30_emu_x_invalid(); break;
    case CRIS_INSN_ADD: len = fr30_emu_add(); break;
    case CRIS_INSN_ADDI: len = fr30_emu_addi(); break;
    case CRIS_INSN_ADD2: len = fr30_emu_add2(); break;
    case CRIS_INSN_ADDC: len = fr30_emu_addc(); break;
    case CRIS_INSN_ADDN: len = fr30_emu_addn(); break;
    case CRIS_INSN_ADDNI: len = fr30_emu_addni(); break;
    case CRIS_INSN_ADDN2: len = fr30_emu_addn2(); break;
    case CRIS_INSN_SUB: len = fr30_emu_sub(); break;
    case CRIS_INSN_SUBC: len = fr30_emu_subc(); break;
    case CRIS_INSN_SUBN: len = fr30_emu_subn(); break;
    case CRIS_INSN_CMP: len = fr30_emu_cmp(); break;
    case CRIS_INSN_CMPI: len = fr30_emu_cmpi(); break;
    case CRIS_INSN_CMP2: len = fr30_emu_cmp2(); break;
    case CRIS_INSN_AND: len = fr30_emu_and(); break;
    case CRIS_INSN_OR: len = fr30_emu_or(); break;
    case CRIS_INSN_EOR: len = fr30_emu_eor(); break;
    case CRIS_INSN_ANDM: len = fr30_emu_andm(); break;
    case CRIS_INSN_ANDH: len = fr30_emu_andh(); break;
    case CRIS_INSN_ANDB: len = fr30_emu_andb(); break;
    case CRIS_INSN_ORM: len = fr30_emu_orm(); break;
    case CRIS_INSN_ORH: len = fr30_emu_orh(); break;
    case CRIS_INSN_ORB: len = fr30_emu_orb(); break;
    case CRIS_INSN_EORM: len = fr30_emu_eorm(); break;
    case CRIS_INSN_EORH: len = fr30_emu_eorh(); break;
    case CRIS_INSN_EORB: len = fr30_emu_eorb(); break;
    case CRIS_INSN_BANDL: len = fr30_emu_bandl(); break;
    case CRIS_INSN_BORL: len = fr30_emu_borl(); break;
    case CRIS_INSN_BEORL: len = fr30_emu_beorl(); break;
    case CRIS_INSN_BANDH: len = fr30_emu_bandh(); break;
    case CRIS_INSN_BORH: len = fr30_emu_borh(); break;
    case CRIS_INSN_BEORH: len = fr30_emu_beorh(); break;
    case CRIS_INSN_BTSTL: len = fr30_emu_btstl(); break;
    case CRIS_INSN_BTSTH: len = fr30_emu_btsth(); break;
    case CRIS_INSN_MUL: len = fr30_emu_mul(); break;
    case CRIS_INSN_MULU: len = fr30_emu_mulu(); break;
    case CRIS_INSN_MULH: len = fr30_emu_mulh(); break;
    case CRIS_INSN_MULUH: len = fr30_emu_muluh(); break;
    case CRIS_INSN_DIV0S: len = fr30_emu_div0s(); break;
    case CRIS_INSN_DIV0U: len = fr30_emu_div0u(); break;
    case CRIS_INSN_DIV1: len = fr30_emu_div1(); break;
    case CRIS_INSN_DIV2: len = fr30_emu_div2(); break;
    case CRIS_INSN_DIV3: len = fr30_emu_div3(); break;
    case CRIS_INSN_DIV4S: len = fr30_emu_div4s(); break;
    case CRIS_INSN_LSL: len = fr30_emu_lsl(); break;
    case CRIS_INSN_LSLI: len = fr30_emu_lsli(); break;
    case CRIS_INSN_LSL2: len = fr30_emu_lsl2(); break;
    case CRIS_INSN_LSR: len = fr30_emu_lsr(); break;
    case CRIS_INSN_LSRI: len = fr30_emu_lsri(); break;
    case CRIS_INSN_LSR2: len = fr30_emu_lsr2(); break;
    case CRIS_INSN_ASR: len = fr30_emu_asr(); break;
    case CRIS_INSN_ASRI: len = fr30_emu_asri(); break;
    case CRIS_INSN_ASR2: len = fr30_emu_asr2(); break;
    case CRIS_INSN_LDI8: len = fr30_emu_ldi8(); break;
    case CRIS_INSN_LDI20: len = fr30_emu_ldi20(); break;
    case CRIS_INSN_LDI32: len = fr30_emu_ldi32(); break;
    case CRIS_INSN_LD: len = fr30_emu_ld(); break;
    case CRIS_INSN_LDUH: len = fr30_emu_lduh(); break;
    case CRIS_INSN_LDUB: len = fr30_emu_ldub(); break;
    case CRIS_INSN_LDR13: len = fr30_emu_ldr13(); break;
    case CRIS_INSN_LDR13UH: len = fr30_emu_ldr13uh(); break;
    case CRIS_INSN_LDR13UB: len = fr30_emu_ldr13ub(); break;
    case CRIS_INSN_LDR14: len = fr30_emu_ldr14(); break;
    case CRIS_INSN_LDR14UH: len = fr30_emu_ldr14uh(); break;
    case CRIS_INSN_LDR14UB: len = fr30_emu_ldr14ub(); break;
    case CRIS_INSN_LDR15: len = fr30_emu_ldr15(); break;
    case CRIS_INSN_LDR15GR: len = fr30_emu_ldr15gr(); break;
    case CRIS_INSN_LDR15DR: len = fr30_emu_ldr15dr(); break;
    case CRIS_INSN_LDR15PS: len = fr30_emu_ldr15ps(); break;
    case CRIS_INSN_ST: len = fr30_emu_st(); break;
    case CRIS_INSN_STH: len = fr30_emu_sth(); break;
    case CRIS_INSN_STB: len = fr30_emu_stb(); break;
    case CRIS_INSN_STR13: len = fr30_emu_str13(); break;
    case CRIS_INSN_STR13H: len = fr30_emu_str13h(); break;
    case CRIS_INSN_STR13B: len = fr30_emu_str13b(); break;
    case CRIS_INSN_STR14: len = fr30_emu_str14(); break;
    case CRIS_INSN_STR14H: len = fr30_emu_str14h(); break;
    case CRIS_INSN_STR14B: len = fr30_emu_str14b(); break;
    case CRIS_INSN_STR15: len = fr30_emu_str15(); break;
    case CRIS_INSN_STR15GR: len = fr30_emu_str15gr(); break;
    case CRIS_INSN_STR15DR: len = fr30_emu_str15dr(); break;
    case CRIS_INSN_STR15PS: len = fr30_emu_str15ps(); break;
    case CRIS_INSN_MOV: len = fr30_emu_mov(); break;
    case CRIS_INSN_MOVDR: len = fr30_emu_movdr(); break;
    case CRIS_INSN_MOVPS: len = fr30_emu_movps(); break;
    case CRIS_INSN_MOV2DR: len = fr30_emu_mov2dr(); break;
    case CRIS_INSN_MOV2PS: len = fr30_emu_mov2ps(); break;
    case CRIS_INSN_JMP: len = fr30_emu_jmp(); break;
    case CRIS_INSN_JMPD: len = fr30_emu_jmpd(); break;
    case CRIS_INSN_CALLR: len = fr30_emu_callr(); break;
    case CRIS_INSN_CALLRD: len = fr30_emu_callrd(); break;
    case CRIS_INSN_CALL: len = fr30_emu_call(); break;
    case CRIS_INSN_CALLD: len = fr30_emu_calld(); break;
    case CRIS_INSN_RET: len = fr30_emu_ret(); break;
    case CRIS_INSN_RET_D: len = fr30_emu_ret_d(); break;
    case CRIS_INSN_INT: len = fr30_emu_int(); break;
    case CRIS_INSN_INTE: len = fr30_emu_inte(); break;
    case CRIS_INSN_RETI: len = fr30_emu_reti(); break;
    case CRIS_INSN_BRAD: len = fr30_emu_brad(); break;
    case CRIS_INSN_BRA: len = fr30_emu_bra(); break;
    case CRIS_INSN_BNOD: len = fr30_emu_bnod(); break;
    case CRIS_INSN_BNO: len = fr30_emu_bno(); break;
    case CRIS_INSN_BEQD: len = fr30_emu_beqd(); break;
    case CRIS_INSN_BEQ: len = fr30_emu_beq(); break;
    case CRIS_INSN_BNED: len = fr30_emu_bned(); break;
    case CRIS_INSN_BNE: len = fr30_emu_bne(); break;
    case CRIS_INSN_BCD: len = fr30_emu_bcd(); break;
    case CRIS_INSN_BC: len = fr30_emu_bc(); break;
    case CRIS_INSN_BNCD: len = fr30_emu_bncd(); break;
    case CRIS_INSN_BNC: len = fr30_emu_bnc(); break;
    case CRIS_INSN_BND: len = fr30_emu_bnd(); break;
    case CRIS_INSN_BN: len = fr30_emu_bn(); break;
    case CRIS_INSN_BPD: len = fr30_emu_bpd(); break;
    case CRIS_INSN_BP: len = fr30_emu_bp(); break;
    case CRIS_INSN_BVD: len = fr30_emu_bvd(); break;
    case CRIS_INSN_BV: len = fr30_emu_bv(); break;
    case CRIS_INSN_BNVD: len = fr30_emu_bnvd(); break;
    case CRIS_INSN_BNV: len = fr30_emu_bnv(); break;
    case CRIS_INSN_BLTD: len = fr30_emu_bltd(); break;
    case CRIS_INSN_BLT: len = fr30_emu_blt(); break;
    case CRIS_INSN_BGED: len = fr30_emu_bged(); break;
    case CRIS_INSN_BGE: len = fr30_emu_bge(); break;
    case CRIS_INSN_BLED: len = fr30_emu_bled(); break;
    case CRIS_INSN_BLE: len = fr30_emu_ble(); break;
    case CRIS_INSN_BGTD: len = fr30_emu_bgtd(); break;
    case CRIS_INSN_BGT: len = fr30_emu_bgt(); break;
    case CRIS_INSN_BLSD: len = fr30_emu_blsd(); break;
    case CRIS_INSN_BLS: len = fr30_emu_bls(); break;
    case CRIS_INSN_BHID: len = fr30_emu_bhid(); break;
    case CRIS_INSN_BHI: len = fr30_emu_bhi(); break;
    case CRIS_INSN_DMOVR13: len = fr30_emu_dmovr13(); break;
    case CRIS_INSN_DMOVR13H: len = fr30_emu_dmovr13h(); break;
    case CRIS_INSN_DMOVR13B: len = fr30_emu_dmovr13b(); break;
    case CRIS_INSN_DMOVR13PI: len = fr30_emu_dmovr13pi(); break;
    case CRIS_INSN_DMOVR13PIH: len = fr30_emu_dmovr13pih(); break;
    case CRIS_INSN_DMOVR13PIB: len = fr30_emu_dmovr13pib(); break;
    case CRIS_INSN_DMOVR15PI: len = fr30_emu_dmovr15pi(); break;
    case CRIS_INSN_DMOV2R13: len = fr30_emu_dmov2r13(); break;
    case CRIS_INSN_DMOV2R13H: len = fr30_emu_dmov2r13h(); break;
    case CRIS_INSN_DMOV2R13B: len = fr30_emu_dmov2r13b(); break;
    case CRIS_INSN_DMOV2R13PI: len = fr30_emu_dmov2r13pi(); break;
    case CRIS_INSN_DMOV2R13PIH: len = fr30_emu_dmov2r13pih(); break;
    case CRIS_INSN_DMOV2R13PIB: len = fr30_emu_dmov2r13pib(); break;
    case CRIS_INSN_DMOV2R15PD: len = fr30_emu_dmov2r15pd(); break;
    case CRIS_INSN_LDRES: len = fr30_emu_ldres(); break;
    case CRIS_INSN_STRES: len = fr30_emu_stres(); break;
    case CRIS_INSN_COPOP: len = fr30_emu_copop(); break;
    case CRIS_INSN_COPLD: len = fr30_emu_copld(); break;
    case CRIS_INSN_COPST: len = fr30_emu_copst(); break;
    case CRIS_INSN_COPSV: len = fr30_emu_copsv(); break;
    case CRIS_INSN_NOP: len = fr30_emu_nop(); break;
    case CRIS_INSN_ANDCCR: len = fr30_emu_andccr(); break;
    case CRIS_INSN_ORCCR: len = fr30_emu_orccr(); break;
    case CRIS_INSN_STILM: len = fr30_emu_stilm(); break;
    case CRIS_INSN_ADDSP: len = fr30_emu_addsp(); break;
    case CRIS_INSN_EXTSB: len = fr30_emu_extsb(); break;
    case CRIS_INSN_EXTUB: len = fr30_emu_extub(); break;
    case CRIS_INSN_EXTSH: len = fr30_emu_extsh(); break;
    case CRIS_INSN_EXTUH: len = fr30_emu_extuh(); break;
    case CRIS_INSN_LDM0: len = fr30_emu_ldm0(); break;
    case CRIS_INSN_LDM1: len = fr30_emu_ldm1(); break;
    case CRIS_INSN_STM0: len = fr30_emu_stm0(); break;
    case CRIS_INSN_STM1: len = fr30_emu_stm1(); break;
    case CRIS_INSN_ENTER: len = fr30_emu_enter(); break;
    case CRIS_INSN_LEAVE: len = fr30_emu_leave(); break;
    case CRIS_INSN_XCHB: len = fr30_emu_xchb(); break;
    default: len = 0; break;
  }
